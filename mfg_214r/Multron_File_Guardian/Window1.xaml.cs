...
namespace MultronFileGuardian
{
    public partial class Window1 : Window
    {
        ...
        private void label10_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Copy operation unsuccessful! Error: " + ex.Message + " " + ex.StackTrace);
            }
        }
