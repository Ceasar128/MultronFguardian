...
namespace Multron_File_Guardian
{
    public class mngProcesses
    {
        ...
        public void shredfile(string fpath)
        {
            ...
            long wfc = 0;
            string formname = "";
            mng.Dispatcher.Invoke(() => { formname = mng.Title; });
            long wd = 0;
            long cwd = 0;
            short nstate = 0;
            try
            ...
            if (nstate == 1)
            {
             ...
             mng.Dispatcher.Invoke(() =>{  mng.Title = formname;   });
        }
        ...
        public async Task<string> aesoperations(string pkey, string fpath, byte encryptstatus, byte[] textb = null)
        {
            ...
            bool shredchoice = false;
            await formbir.formuc.Dispatcher.InvokeAsync(async () =>
            {
                delchoice = (bool)formbir.formuc.dfafterencrypted1.IsChecked;
                shredchoice = (bool)formbir.formuc.shredbd.IsChecked;
            });
