            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    if (openFileDialog1.FileName.Contains(".mng"))
                    {
                        ...
                        {
                            System.Threading.Thread thaesd = new Thread(() => textBox1.Text = aesoperations(textBox2.Text, openFileDialog1.FileName, 2));
                            thaesd.Start();
                        }

                        if (comboBox1.Text == "Serpent")
                        {
                            System.Threading.Thread thd = new Thread(() => textBox1.Text = ciphersoperations(textBox2.Text, new SerpentEngine(), openFileDialog1.FileName, 2));
                            thd.Start();
                        }
                        if (comboBox1.Text == "Camellia")
                        {
                            System.Threading.Thread thsd = new Thread(() => textBox1.Text = ciphersoperations(textBox2.Text, new CamelliaEngine(), openFileDialog1.FileName, 2));
                            thsd.Start();
                        }
                        if (comboBox1.Text == "Twofish")
                        {
                            System.Threading.Thread thad = new Thread(() => textBox1.Text = ciphersoperations(textBox2.Text, new TwofishEngine(), openFileDialog1.FileName, 2));
                            thad.Start();
                        }
                        if (comboBox1.Text == "SM4")
                        {
                            System.Threading.Thread sthd = new Thread(() => textBox1.Text = ciphersoperations(textBox2.Text, new SM4Engine(), openFileDialog1.FileName, 2));
                            sthd.Start();
                        }
                        if (comboBox1.Text == "ThreeFish")
                        {
                            System.Threading.Thread thjhd = new Thread(() => textBox1.Text = ciphersoperations(textBox2.Text, new ThreefishEngine(keysize), openFileDialog1.FileName, 2, null, (short)(keysize / 8)));
                            thjhd.Start();
                        }
                        if (comboBox1.Text == "ChaCha20")
                        {
                            System.Threading.Thread tchhd = new Thread(() => textBox1.Text = chachaoperations(textBox2.Text, openFileDialog1.FileName, 2));
                            tchhd.Start();
                        }
                    }
                    else
            ...
            if (checkfs == 1)
            {
                if (checkBox1.Checked == true)
                {
                    if (textBox2.Text != "")
                    {
                        ...
                        if (comboBox1.Text == "ChaCha20")
                        {
                            System.Threading.Thread willstaypic = new Thread(() => chachaoperations(textBox2.Text, filepathh, 1, System.Text.Encoding.UTF8.GetBytes(textBox1.Text)));
                            willstaypic.Start();
                        }
                    }
                    else
